...
impl AssetRegistry<Runtime> for MantaAssetRegistry {
    type Metadata = AssetStorageMetadata<Balance, DolphinAssetId, DolphinAssetId, DolphinAssetId, AccountId>;
    ...
    fn get_metadata(
        asset_id: &DolphinAssetId,
    ) -> Option<AssetStorageMetadata<Balance, DolphinAssetId, DolphinAssetId, DolphinAssetId, AccountId>> {
...
impl AssetConfig<Runtime> for DolphinAssetConfig {
    ...
    type IdentifierMapping = AssetIdMapping<DolphinAssetId, DolphinAssetId, DolphinAssetId, AccountId>;
